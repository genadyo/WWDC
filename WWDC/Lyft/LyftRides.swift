...
//  Examples:
//
//  Lyft.requestRide(RequestRidePost(originLat: 34.305658, originLng: -118.8893667, originAddress: "123 Main St, Anytown, CA", destinationLat: 36.9442175, destinationLng: -123.8679133, destinationAddress: "123 Main St, Anytown, CA", rideType: .Lyft)) { response, error in
//
//  }
...
extension Lyft {
    static func requestRide(requestRidePost: RequestRidePost, completionHandler: ((response: Ride?, error: NSError?) -> ())?) {
