...
//  WWDC
//
//  Created by Genady Okrain on 4/21/16.
...
public class Assets : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfLyft: UIImage?
        static var lyftTargets: [AnyObject]?
    }
    ...
    public class func drawEnvelope() {
        ...
        //// Welcome
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 8, 6)
        ...
        main2Path.moveToPoint(CGPoint(x: -8, y: -6))
        main2Path.addLineToPoint(CGPoint(x: -8, y: -4))
        ...
        main2Path.addLineToPoint(CGPoint(x: -8, y: -6))
        main2Path.closePath()
        main2Path.moveToPoint(CGPoint(x: -8, y: -2))
        main2Path.addLineToPoint(CGPoint(x: -8, y: 6))
        main2Path.addLineToPoint(CGPoint(x: 8, y: 6))
        main2Path.addLineToPoint(CGPoint(x: 8, y: -2))
    ...
    public class func drawLyft() {
        //// Color Declarations
        let fillColor7 = UIColor(red: 0.985, green: 0.000, blue: 0.696, alpha: 1.000)

        //// Page-1
        //// logo_standard
        //// Page-
        //// logos
        //// logo_standard 2 Drawing
        let logo_standard2Path = UIBezierPath()
        logo_standard2Path.moveToPoint(CGPoint(x: 25, y: 62.3))
        logo_standard2Path.addLineToPoint(CGPoint(x: 55.1, y: 62.3))
        logo_standard2Path.addLineToPoint(CGPoint(x: 55.1, y: 143))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 65.6, y: 166.6), controlPoint1: CGPoint(x: 55.1, y: 155.8), controlPoint2: CGPoint(x: 60.9, y: 163.4))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 34.6, y: 165.5), controlPoint1: CGPoint(x: 60.7, y: 170.9), controlPoint2: CGPoint(x: 45.8, y: 174.7))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 25, y: 142.7), controlPoint1: CGPoint(x: 28, y: 160.1), controlPoint2: CGPoint(x: 25, y: 151.1))
        logo_standard2Path.addLineToPoint(CGPoint(x: 25, y: 62.3))
        logo_standard2Path.addLineToPoint(CGPoint(x: 25, y: 62.3))
        logo_standard2Path.closePath()
        logo_standard2Path.moveToPoint(CGPoint(x: 212.9, y: 129.4))
        logo_standard2Path.addLineToPoint(CGPoint(x: 212.9, y: 120.9))
        logo_standard2Path.addLineToPoint(CGPoint(x: 222.1, y: 120.9))
        logo_standard2Path.addLineToPoint(CGPoint(x: 222.1, y: 91.2))
        logo_standard2Path.addLineToPoint(CGPoint(x: 212, y: 91.2))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 173.2, y: 60), controlPoint1: CGPoint(x: 208.1, y: 73.3), controlPoint2: CGPoint(x: 192.2, y: 60))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 133.5, y: 99.7), controlPoint1: CGPoint(x: 151.3, y: 60), controlPoint2: CGPoint(x: 133.5, y: 77.8))
        logo_standard2Path.addLineToPoint(CGPoint(x: 133.5, y: 169))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 153.5, y: 163.6), controlPoint1: CGPoint(x: 139.7, y: 169.9), controlPoint2: CGPoint(x: 147.2, y: 168.9))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 163.1, y: 140.8), controlPoint1: CGPoint(x: 160.1, y: 158.2), controlPoint2: CGPoint(x: 163.1, y: 149.2))
        logo_standard2Path.addLineToPoint(CGPoint(x: 163.1, y: 138.2))
        logo_standard2Path.addLineToPoint(CGPoint(x: 178.1, y: 138.2))
        logo_standard2Path.addLineToPoint(CGPoint(x: 178.1, y: 108.5))
        logo_standard2Path.addLineToPoint(CGPoint(x: 163.1, y: 108.5))
        logo_standard2Path.addLineToPoint(CGPoint(x: 163.1, y: 99.5))
        logo_standard2Path.addLineToPoint(CGPoint(x: 163.1, y: 99.5))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 173.2, y: 89.4), controlPoint1: CGPoint(x: 163.1, y: 93.9), controlPoint2: CGPoint(x: 167.6, y: 89.4))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 183.3, y: 99.5), controlPoint1: CGPoint(x: 178.8, y: 89.4), controlPoint2: CGPoint(x: 183.3, y: 93.9))
        logo_standard2Path.addLineToPoint(CGPoint(x: 183.3, y: 129.3))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 223, y: 169), controlPoint1: CGPoint(x: 183.3, y: 151.2), controlPoint2: CGPoint(x: 201.1, y: 169))
        logo_standard2Path.addLineToPoint(CGPoint(x: 223, y: 139.4))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 212.9, y: 129.4), controlPoint1: CGPoint(x: 217.4, y: 139.4), controlPoint2: CGPoint(x: 212.9, y: 134.9))
        logo_standard2Path.addLineToPoint(CGPoint(x: 212.9, y: 129.4))
        logo_standard2Path.closePath()
        logo_standard2Path.moveToPoint(CGPoint(x: 99.1, y: 91.1))
        logo_standard2Path.addLineToPoint(CGPoint(x: 99.1, y: 134.8))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 94.5, y: 139.3), controlPoint1: CGPoint(x: 99.1, y: 137.3), controlPoint2: CGPoint(x: 97, y: 139.3))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 89.9, y: 134.8), controlPoint1: CGPoint(x: 92, y: 139.3), controlPoint2: CGPoint(x: 89.9, y: 137.3))
        logo_standard2Path.addLineToPoint(CGPoint(x: 89.9, y: 91.1))
        logo_standard2Path.addLineToPoint(CGPoint(x: 60.2, y: 91.1))
        logo_standard2Path.addLineToPoint(CGPoint(x: 60.2, y: 142.4))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 77.6, y: 167.1), controlPoint1: CGPoint(x: 60.2, y: 151.6), controlPoint2: CGPoint(x: 63.3, y: 163.3))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 100.1, y: 163), controlPoint1: CGPoint(x: 91.9, y: 170.9), controlPoint2: CGPoint(x: 100.1, y: 163))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 86.6, y: 172.8), controlPoint1: CGPoint(x: 99.3, y: 168.2), controlPoint2: CGPoint(x: 94.5, y: 172))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 69.2, y: 169.8), controlPoint1: CGPoint(x: 80.6, y: 173.4), controlPoint2: CGPoint(x: 73, y: 171.4))
        logo_standard2Path.addLineToPoint(CGPoint(x: 69.2, y: 197))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 99.2, y: 198.8), controlPoint1: CGPoint(x: 78.9, y: 199.9), controlPoint2: CGPoint(x: 89.1, y: 200.8))
        logo_standard2Path.addCurveToPoint(CGPoint(x: 128.9, y: 159.8), controlPoint1: CGPoint(x: 117.4, y: 195.3), controlPoint2: CGPoint(x: 128.9, y: 180.1))
        logo_standard2Path.addLineToPoint(CGPoint(x: 128.9, y: 90.9))
        logo_standard2Path.addLineToPoint(CGPoint(x: 99.1, y: 90.9))
        logo_standard2Path.addLineToPoint(CGPoint(x: 99.1, y: 91.1))
        logo_standard2Path.closePath()
        logo_standard2Path.miterLimit = 4;

        logo_standard2Path.usesEvenOddFillRule = true;

        fillColor7.setFill()
        logo_standard2Path.fill()
    }
    ...
    public class var imageOfLyft: UIImage {
        if Cache.imageOfLyft != nil {
            return Cache.imageOfLyft!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 250, height: 250), false, 0)
            Assets.drawLyft()

        Cache.imageOfLyft = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()
    ...
    @IBOutlet var lyftTargets: [AnyObject]! {
        get { return Cache.lyftTargets }
        set {
            Cache.lyftTargets = newValue
            for target: AnyObject in newValue {
                target.performSelector(NSSelectorFromString("setImage:"), withObject: Assets.imageOfLyft)
            }
        }
    }
